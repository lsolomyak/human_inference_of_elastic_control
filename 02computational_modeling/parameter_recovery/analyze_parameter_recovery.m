function analyze_parameter_recovery(fits_table, data_struct)
    ...
    % Create valid indices array (excluding index 168)
    ...
    sgtitle('Parameter Recovery Analysis', 'FontSize', 14, 'FontWeight', 'bold');
